...
// and then returns the equivalent Fahrenheit value.
...
double celsiusToFahrenheit(int degrees);

int main() {
    int degreesInCelsius;

    cout << "Please enter a Celsius value: ";
    cin >> degreesInCelsius;
    cout << "20 degrees Celsius is " << celsiusToFahrenheit(degreesInCelsius) << " degrees Fahrenheit." << endl;
