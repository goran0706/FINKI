...
// Да се напише програма која за секој прочитан број на стандарден излез ќе ги отпечати неговите цифри кои се поголеми од К,
// како и збирот на цифрите кои се отпечатени.
