// For one integer b we say that is a parity complement of other integer a if and only if in the number
// b all the even digits of the number a are replaced with the corresponding (odd) digit increased by 1,
...
// (those are: 8750, 78512, 12116, 7, 0, 90 and 31597, respectively), and print the 5 smallest of them in this order: 0 7 90 8750 12116.
//
