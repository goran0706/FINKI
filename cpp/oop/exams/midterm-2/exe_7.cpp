/*
    ...
    За секоја картичка се чуваат:

    - информации за трансакциска сметка (низа од 15 знаци),
    - пин код (цел број) и
    - дали има повеќе пин кодови (булова променлива).
    ...
    Фатете го исклучокот во главната функција каде што е потребно. Откако ќе го фатите отпечатете соодветна порака за грешка
