/*
    ...
    За секоја книга се чуваат:

    - податоци за ISBN бројот (низа од најмногу 20 знаци),
    - насловот (низа од најмногу 50 знаци),
    - авторот (низа од најмногу 30 знаци) и
    - основната цена изразена во $ (реален број).
    ...
    - void mostExpensiveBook (Book** books, int n) во која се печати вкупниот број на онлајн, односно, печатени книги во проследената низа посебно. (5 поени)
