/*
    ...
    - ако делото е напишано во 20 или 21 век, М = 75ден.
    - ако делото е напишано во 19 век и М = 100ден.
    - ако делото е напишано пред 19 век. N = 100ден
    - ако делото е од Италија, N = 150ден
    - ако делото е од Русија. Делата од останатите земји имаат N = 80ден.
    ...
    Да се дефинира надворешна функција brojPretstaviNaDelo која како аргумент прима низа од покажувачи кон претстави кои се прикажале во еден месец,
    големина на низата и едно дело. Оваа функција пресметува на колку од дадените претстави е прикажано даденото дело. (5 поени)
