/*
    Да се креира структура Proizvod во која се чуваат:

    - податоци за кодот напрозиводот (низа од 20 знаци),
    - единична цена на производ (цел број),
    - бројот на достапни производи кои ги има во еден магацин (цел број) .

    Потоа да се креирa структура Narachka во која се чуваат:

    - податоци за името лицето кое ја прави нарачката (низи од 15 знаци),
    - низа од Proizvodi (максимум 10) кои ги има во нарачката,
    - низа од бројот на нарачани производи за секоја производ посебно (максимум10) и
    - бројот на производи во нарачката .

    Треба да се направи функција со потпис

    void pecatiFaktura(Narachka n) која што ќе ги отпечати една фактура за една нарачка (n) .
